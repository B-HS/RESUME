            ...
            designsystem: {
                ...
                description: [
                    ...
                    },
                    {
                        ...
                        explaination:
                            '기존에는 ECS/EC2를 사용하여 배포했으나, 이번 프로젝트에서는 EC2 인스턴스를 운영할 정도의 리소스가 필요하지 않았습니다.  따라서 GitHub Actions을 활용해 GitHub Pages 배포를 위한 CI/CD 파이프라인을 .',
                    },
                    {
                        detail: 'Storybook 도입 및 컴포넌트 라이브러리 구축',
                        explaination:
                            'flunti.io 구축 시에 시범적으로 도입한 storybook, 그리고 디자이너분과의 긴밀한 소통과 QA를 위하여 storybook을 본격적으로 도입하였습니다. 실험적으로 도입된 vitest도 도입되어 보다 문제 없는 컴포넌트를 구현할 수 있게 되었습니다.',
                    },
                ],
            ...
            flunti: {
                ...
                description: [
                    ...
                    },
                    {
                        ...
                        explaination:
                            '디자이너분과의 협업을 통하여, Webp파일을 이용 및 Next.js의 image컴포넌트를 이용하여 로딩 속도를 개선하였습니다. 실제 큰 이미지가 들어가는 페이지 로딩 속도가 최대 5초까지 걸리던 문제를 1초 이하로 단축하였습니다.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        explaination:
                            '백엔드 파트와 협업하며 문제였던 것은 Next.js SSR에서의 문제 파악이었습니다.  서버 사이드 페이지의 로깅은 백엔드 담당자분이 하나씩 직접 확인해야 하는 상태에서, sentry, hyperdx등 에러 로깅 솔루션 도입을 제안하고 이에따라 버그 추적을 효율적으로 할 수 있게 개선되었습니다.',
                    },
                    {
            ...
            codetest: {
                ...
                description: [
                    ...
                    },
                    {
                        ...
                        explaination:
                            'Monaco, CodeMirror, ACE 등 많은 선택지, 처음부터 다시 구현 하는 것도 범위에 포함되어있었으나, MVP 단계의 빠른 개발을 위하여, 그리고 react에 대해서의 레퍼런스가 많은 code mirror를 사용하게 되었습니다',
                    },
                    {
            ...
            otherCompany: {
                ...
                description: [
                    ...
                    },
                    {
                        ...
                        explaination:
                            '어드민 페이지를 운용하는데 있어서, 데이터를 엑셀로 필요로하는 요구에 따라 JSON을 XLSX로 변환하는 모듈 개발과 기능 구현, 신청서를 한 눈에 보고 출력할 수 있는페이지 등을 구현하여 어드민 사용자의 편의성을 향상시켰습니다.',
                    },
                    {
                ...
                description: [
                    {
                        ...
                        explaination:
                            '디자이너분과의 협의하여 이미 구현된 UI라이브러리를 사용하기로 결정하였으며 shadcn/ui를 제안 후 체용되었습니다.  이후 preset활용을 이용하여 빠르게 개발하는 것이 가능해졌습니다.',
                    },
                    {
                        detail: 'FSD 아키텍처 도입',
                        explaination:
                    ...
                    },
                    {
                        ...
                        explaination:
                            '기존에 Next.js에서 쓰던 videojs로 작성된 플레이어는 적용이 힘들며, 컴포넌트가 dash라이브로리에 종속되어 복호화가 필수적으로 적용되는 상태였습니다.  제한된 환경에서 이를 분석하고 이식하는 것은 불가능하다 판단하여 React Player를 이용하여 디자인 시안과 기획에 맞는 비디오 플레이어를 구현해내었습니다.',
                    },
                    {
