        ...
        history: [
            {
                ...
                background: [
                    ...
                    '기존 페이지는 캐싱을 하고 있지 않아서 무거운 API의 호출이 반복되어 성능 저하를 초래함.',
                ],
                implementation: [
                    ...
                    'Fetch API를 이용한 server prefetch wrapper 구현 및 tanstack query와 통합하여 DX, UX상승',
                    'Nextjs의 캐싱된 API를 관리를 위해 Revalidate api 구현 및 유틸리티 구현',
                ],
                results: [
            ...
            },
            {
                title: 'SaaS 구현',
                background: [
                    '비즈니스 드라이빙 파트에서 기업별 페이지를 구축해야하는 요구사항이 계속 발생',
                    '기업별 페이지를 구축하기 위해 매번 새로운 페이지를 작성해야하는 상황 발생',
                ],
                implementation: [
                    'Nextjs의 middleware와 서버사이드 렌더링을 적극 이용, 기업별 정보에따른 분기된 렌더링을 구현',
                    'favicon, SEO, 사이트 테마 색상, 커스텀 메인페이지를 위한 어드민 등을 구현'
                ],
                results: [
                    '기업별 페이지를 구축하기 위해 매번 새로운 페이지를 작성해야하는 상황 개선', 
                    '개발자의 개입이 최소화된 형태로 사이트 관리자가 비즈니스 드라이빙이 가능해짐',
                    'SaaS 형태를 고려하였으므로 모듈화에 따른 추가 기능 개발이 용이해짐',
                ],
            },
            {
                title: '디자인 시스템 / 컴포넌트 도큐먼트 페이지 구축',
                background: [
