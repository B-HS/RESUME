    ...
    ko: [
        {
            ...
            description: {
                background: [
                    ...
                    '소셜 피드및 외부 콘텐츠를 통합 관리할 수 있는 개인 기술 플랫폼 필요',
                ],
                implementation: [
                    'Next.js + TypeScript 기반 구조를 재설계하고 Drizzle + Better Auth를 이용한 인증 및 데이터 관리 체계를 구성',
    ...
    jp: [
        {
            ...
            description: {
                ...
                implementation: [
                    'Next.js + TypeScriptベースで構造を再設計し、Drizzle + Better Authを用いた認証およびデータ管理体系を構築。',
                ...
                results: [
                    ...
                    '認証、API連携、データ処理など、サービスのコア機能全般を自ら実装したことで、フルスタックな開発ノウハウを習得。',
                ],
            },
        },
        {
