...
public class GuestbookRepositoryTests {
    ...
    public void testQuery1() {
        ...
        BooleanExpression expression = qGuestbook.title.contains(keyword); // 3 질의를 위한 식을 작성
    ...
    public void testQuery2() {
        ...
        BooleanExpression exTitle = qGuestbook.title.contains(keyword); // 3 질의를 위한 식을 작성(for title)
        BooleanExpression exConTent = qGuestbook.content.contains(keyword); // 3 질의를 위한 식을 작성(for context)
